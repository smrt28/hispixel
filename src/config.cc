...
Config_t::Action_t string_to_action(parser::Parslet_t &p) {
    ...
    if (s == "workspace_1") return Action_t(Action_t::ACTION_SET_WORKSPACE, 0);
    if (s == "workspace_2") return Action_t(Action_t::ACTION_SET_WORKSPACE, 1);
    if (s == "workspace_3") return Action_t(Action_t::ACTION_SET_WORKSPACE, 2);
    if (s == "workspace_4") return Action_t(Action_t::ACTION_SET_WORKSPACE, 3);
